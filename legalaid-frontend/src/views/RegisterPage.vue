  ...
  <div class="min-h-screen bg-[#F8FAFC] flex items-center justify-center px-4 py-12">
    <div class="w-full max-w-md">
      ...
      <div class="text-center mb-8">
        ...
        <h1 class="text-2xl font-bold text-navy-900">Buat Akun LegalAid AI</h1>
        <p class="text-sm text-navy-500 mt-1">Daftar untuk mulai berkonsultasi hukum</p>
      </div>
      ...
      <p class="text-center text-sm text-navy-500 mt-6">
        Sudah punya akun?
        <RouterLink to="/login" class="text-royal-600 hover:text-royal-700 font-semibold">Masuk</RouterLink>
      </p>
    </div>
  </div>
</template>
